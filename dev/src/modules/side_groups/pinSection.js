...
function addStreamer(streamerInfo){
    ...
    if(streamerIsStreaming){
        ...
        div10.className="tw-border-radius-rounded tw-channel-status-indicator-groupLiveColor tw-channel-status-indicator--live tw-channel-status-indicator--small tw-inline-block tw-relative"
