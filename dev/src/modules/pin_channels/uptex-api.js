   ...
   */
    getStreamerInfo(streamerID){
        return new Promise((resolve,reject)=>{
            ...
            uptexAPI.get("streamerInfo?streamerID="+cryptedID).then((data)=>{
                resolve(data.info)
            }).catch((err)=>{
                reject(err)
            })
    ...
    addStreamer(userID,streamerID){
        return new Promise((resolve,reject)=>{
            ...
            uptexAPI.put('pin?userID='+userCryptedID+'&streamerID='+streamerCryptedID).then(()=>{
                resolve()
            }).catch((err)=>{
                reject(err)
            })
    ...
    deleteStreamer(userID,streamerID){
        return new Promise((resolve,reject)=>{
            let userCryptedID = getCryptedId(userID)
            let streamerCryptedID = getCryptedId(streamerID)
            uptexAPI.delete('pin?userID='+userCryptedID+'&streamerID='+streamerCryptedID).then(()=>{
                resolve()
            }).catch((err)=>{
                reject(err)
            })
